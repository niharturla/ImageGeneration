...
class GAN_Model(pl.LightningModule):
  ...
  def training_step(self, batch, batch_idx): # Remove optimizer_idx
    ...
    opt_g.zero_grad()
    self.manual_backward(g_loss) # Use manual_backward
    opt_g.step()
    ...
    opt_d.zero_grad()
    self.manual_backward(d_loss) # Use manual_backward
    opt_d.step()
    self.log('d_loss', d_loss, prog_bar=True)

  # ... (rest of the code remains the same) ...

  # adjust learning rates affectively
